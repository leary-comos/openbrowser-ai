"""
Example of using LangChain models with openbrowser.

This example demonstrates how to:
1. Wrap a LangChain model with ChatLangchain
2. Use it with a openbrowser Agent
3. Run a simple web automation task

@file purpose: Example usage of LangChain integration with openbrowser
"""
...
async def main():
	...
	# Wrap it with ChatLangchain to make it compatible with openbrowser
